...
// build and append the summary paragraph
const summaryStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfundedCount} ${unfundedCount === 1 ? 'game' : 'games'} remain unfunded.`;
